...
@section('content')
<section class="py-24 px-6 bg-dark-950 overflow-hidden">
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
            
            <!-- Contact Info -->
            <div>
                <h1 class="text-3xl md:text-5xl font-bold mb-8">Get In <span class="text-neon-blue">Touch</span></h1>
                <p class="text-gray-400 text-base md:text-lg mb-12 leading-relaxed max-w-lg">
                ...
                <div class="space-y-6 md:space-y-8 mb-12">
                    <div class="flex items-start gap-4 md:gap-6 group">
                        <div class="w-10 h-10 md:w-12 md:h-12 bg-neon-blue/10 rounded-xl flex items-center justify-center group-hover:bg-neon-blue transition-colors duration-300">
                            <i class="fa-solid fa-envelope text-neon-blue group-hover:text-white transition-colors duration-300 text-sm md:text-base"></i>
                        </div>
                        <div>
                            <h4 class="text-[10px] md:text-sm font-bold text-gray-500 uppercase tracking-widest mb-1">Email Us</h4>
                            <p class="text-base md:text-lg font-medium text-white break-all">info@worldoftech.company</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4 md:gap-6 group">
                        <div class="w-10 h-10 md:w-12 md:h-12 bg-green-500/10 rounded-xl flex items-center justify-center group-hover:bg-green-500 transition-colors duration-300">
                            <i class="fa-solid fa-phone text-green-500 group-hover:text-white transition-colors duration-300 text-sm md:text-base"></i>
                        </div>
                        <div>
                            <h4 class="text-[10px] md:text-sm font-bold text-gray-500 uppercase tracking-widest mb-1">Call / WhatsApp</h4>
                            <p class="text-base md:text-lg font-medium text-white">+92 322 0275616</p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4 md:gap-6 group">
                        <div class="w-10 h-10 md:w-12 md:h-12 bg-purple-500/10 rounded-xl flex items-center justify-center group-hover:bg-neon-purple transition-colors duration-300">
                            <i class="fa-solid fa-location-dot text-neon-purple group-hover:text-white transition-colors duration-300 text-sm md:text-base"></i>
                        </div>
                        <div>
                            <h4 class="text-[10px] md:text-sm font-bold text-gray-500 uppercase tracking-widest mb-1">Location</h4>
                            <p class="text-base md:text-lg font-medium text-white">Karachi, Pakistan</p>
                        </div>
                    </div>
                </div>

                <!-- Map -->
                <div class="rounded-3xl overflow-hidden border border-gray-800 grayscale h-48 md:h-64 shadow-2xl">
            ...
            <!-- Contact Form -->
            <div class="bg-dark-900 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 border border-gray-800 shadow-2xl relative">
